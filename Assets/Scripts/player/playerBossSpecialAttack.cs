...
public class playerBossSpecialAttack : MonoBehaviour
{
    ...
    public int marginPlayerSP = 19; // a margin for Speed Points is used to limit the numbers of Special Attacks
    ...
    void Start()
    {
        currentPlayerSP = 40; // the player starts with 20 Speed Points
    ...
    void SpecialAttack()
    {
        ...
        {
            enemy.GetComponent<bossHP>().takeDamage(specialattackDamage);
        }
    }
